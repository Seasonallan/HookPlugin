...
import com.season.hookplugin.compat.ParceledListSliceCompat;
 ...
 */
public class HookHandlePackageManager extends BaseHookHandle {

    private static final String TAG = HookHandlePackageManager.class.getSimpleName();

    public HookHandlePackageManager(Context hostContext) {
        super(hostContext);
    }
    ...
    private class getPackageInfo extends BaseHookMethodHandler {
        ...
        protected boolean beforeInvoke(Object receiver, Method method, Object[] args) throws Throwable {
         ...
         /*public PackageInfo getPackageInfo(String packageName, int flags, int userId) throws RemoteException;*/
            if (args != null) {
                ...
                if (HookHandlePackageManager.class.getName() != null) {
                    PackageInfo packageInfo = PluginManager.getInstance().getPackageInfo(packageName, flags);
                    if (packageInfo != null) {
                        setFakedResult(packageInfo);
                        return true;
                    } else {
                        LogPlugin.i(TAG, "getPackageInfo(%s) fail,pkginfo is null", packageName);
                    }
                }
    ...
    private class getPackageUid extends BaseHookMethodHandler {
    ...
    private class getPackageGids extends BaseHookMethodHandler {
    ...
    private class currentToCanonicalPackageNames extends BaseHookMethodHandler {
    ...
    private class canonicalToCurrentPackageNames extends BaseHookMethodHandler {
    ...
    private class getPermissionInfo extends BaseHookMethodHandler {
    ...
    private class queryPermissionsByGroup extends BaseHookMethodHandler {
    ...
    private class getPermissionGroupInfo extends BaseHookMethodHandler {
    ...
    private class getAllPermissionGroups extends BaseHookMethodHandler {
    ...
    private class getApplicationInfo extends BaseHookMethodHandler {
    ...
    private class getActivityInfo extends BaseHookMethodHandler {
    ...
    private class getReceiverInfo extends BaseHookMethodHandler {
    ...
    private class getServiceInfo extends BaseHookMethodHandler {
    ...
    private class getProviderInfo extends BaseHookMethodHandler {
    ...
    private class checkPermission extends BaseHookMethodHandler {
    ...
    private class checkUidPermission extends BaseHookMethodHandler {
    ...
    private class addPermission extends BaseHookMethodHandler {
    ...
    private class grantPermission extends BaseHookMethodHandler {
    ...
    private class revokePermission extends BaseHookMethodHandler {
    ...
    private class checkSignatures extends BaseHookMethodHandler {
    ...
    private class getPackagesForUid extends BaseHookMethodHandler {
    ...
    private class getNameForUid extends BaseHookMethodHandler {
    ...
    private class getUidForSharedUser extends BaseHookMethodHandler {
    ...
    private class getFlagsForUid extends BaseHookMethodHandler {
...
//        NO
    ...
    private class resolveIntent extends BaseHookMethodHandler {
    ...
    private class queryIntentActivities extends BaseHookMethodHandler {
    ...
    private class queryIntentActivityOptions extends BaseHookMethodHandler {
    ...
    private class queryIntentReceivers extends BaseHookMethodHandler {
    ...
    private class resolveService extends BaseHookMethodHandler {
    ...
    private class queryIntentServices extends BaseHookMethodHandler {
    ...
    private class queryIntentContentProviders extends BaseHookMethodHandler {
    ...
    private class getInstalledPackages extends BaseHookMethodHandler {
    ...
    private class getPackagesHoldingPermissions extends BaseHookMethodHandler {
    ...
    private class getInstalledApplications extends BaseHookMethodHandler {
        ...
        /* public ParceledListSlice getInstalledApplications(int flags, int userId) throws RemoteException */
            try {
                ...
                LogPlugin.e(TAG, "fake getInstalledApplications", e);
            }
            super.afterInvoke(receiver, method, args, invokeResult);
        }
    }

    private class getPersistentApplications extends BaseHookMethodHandler {
    ...
    private class resolveContentProvider extends BaseHookMethodHandler {
    ...
    private class querySyncProviders extends BaseHookMethodHandler {
    ...
    private class queryContentProviders extends BaseHookMethodHandler {
    ...
    private class getInstrumentationInfo extends BaseHookMethodHandler {
    ...
    private class queryInstrumentation extends BaseHookMethodHandler {
    ...
    private class getInstallerPackageName extends BaseHookMethodHandler {
    ...
    private class addPackageToPreferred extends BaseHookMethodHandler {
    ...
    private class removePackageFromPreferred extends BaseHookMethodHandler {
    ...
    private class getPreferredPackages extends BaseHookMethodHandler {
    ...
    private class resetPreferredActivities extends BaseHookMethodHandler {
    ...
    private class getLastChosenActivity extends BaseHookMethodHandler {
    ...
    private class setLastChosenActivity extends BaseHookMethodHandler {
    ...
    private class addPreferredActivity extends BaseHookMethodHandler {
    ...
    private class replacePreferredActivity extends BaseHookMethodHandler {
    ...
    private class clearPackagePreferredActivities extends BaseHookMethodHandler {
    ...
    private class getPreferredActivities extends BaseHookMethodHandler {
    ...
    private class getHomeActivities extends BaseHookMethodHandler {
    ...
    private class setComponentEnabledSetting extends BaseHookMethodHandler {
    ...
    private class getComponentEnabledSetting extends BaseHookMethodHandler {
    ...
    private class setApplicationEnabledSetting extends BaseHookMethodHandler {
    ...
    private class getApplicationEnabledSetting extends BaseHookMethodHandler {
    ...
    private class setPackageStoppedState extends BaseHookMethodHandler {
    ...
    private class getPackageSizeInfo extends BaseHookMethodHandler {
    ...
    private class performDexOpt extends BaseHookMethodHandler {
    ...
    private class movePackage extends BaseHookMethodHandler {
