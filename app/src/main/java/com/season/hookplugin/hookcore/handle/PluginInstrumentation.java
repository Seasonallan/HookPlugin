...
import com.season.hookplugin.hookcore.ProxyHookPackageManager;
...
public class PluginInstrumentation extends Instrumentation {
    ...
    public void callActivityOnCreate(Activity activity, Bundle icicle) {
        if (enable) {
            ...
            try {
                ...
                LogPlugin.e(TAG, "callActivityOnCreate:fakeSystemService", e);
            }
            try {
                onActivityCreated(activity);
            } catch (RemoteException e) {
                LogPlugin.e(TAG, "callActivityOnCreate:onActivityCreated", e);
            }

            try {
                fixBaseContextImplOpsPackage(activity.getBaseContext());
            } catch (Exception e) {
                LogPlugin.e(TAG, "callActivityOnCreate:fixBaseContextImplOpsPackage", e);
            }

            try {
                fixBaseContextImplContentResolverOpsPackage(activity.getBaseContext());
            } catch (Exception e) {
                LogPlugin.e(TAG, "callActivityOnCreate:fixBaseContextImplContentResolverOpsPackage", e);
            }
            ...
            if (mOpPackageName != null) {
                ...
                if (valueObj instanceof String) {
                    ...
                    if (!TextUtils.equals(opPackageName, mHostContext.getPackageName())) {
                        ...
                        LogPlugin.i(TAG, "fixBaseContextImplOpsPackage OK!Context=%s,", baseContext);
                    }
                }
            }
        }
                ...
                if (valueObj instanceof ContentResolver) {
                    ...
                    if (mPackageNameValueObj != null && mPackageNameValueObj instanceof String) {
                        ...
                        if (!TextUtils.equals(packageName, mHostContext.getPackageName())) {
                            ...
                            LogPlugin.i(TAG, "fixBaseContextImplContentResolverOpsPackage OK!Context=%s,contentResolver=%s", baseContext, contentResolver);
                        }
                    }
    ...
    private void onActivityCreated(Activity activity) throws RemoteException {
        try {
            ...
            LogPlugin.i(TAG, "onActivityCreated fail", e);
        }
    }
    ...
    private void fixTaskDescription(Activity activity, ActivityInfo targetInfo) {
        try {
            ...
            LogPlugin.w(TAG, "fixTaskDescription fail", e);
        }
    }
    ...
    public void callActivityOnDestroy(Activity activity) {
        ...
        if (enable) {
            try {
                ...
                LogPlugin.e(TAG, "callActivityOnDestroy:onActivityDestory", e);
            }
        }
    }
    ...
    public void callApplicationOnCreate(Application app) {
        if (enable) {
            ...
            try {
                ...
                LogPlugin.e(TAG, "fakeSystemService", e);
            }

            try {
                fixBaseContextImplOpsPackage(app.getBaseContext());
            } catch (Exception e) {
                LogPlugin.e(TAG, "callApplicationOnCreate:fixBaseContextImplOpsPackage", e);
            }
        ...
        if (enable) {
            try {
                ...
                LogPlugin.e(TAG, "registerStaticReceiver", e);
            }
        }
    }
...
//        }
        try {
            ...
            LogPlugin.e(TAG, "callActivityOnNewIntent:read EXTRA_TARGET_INTENT", e);
        }
        if (enable) {
            try {
                onActivityOnNewIntent(activity, intent);
            } catch (RemoteException e) {
                LogPlugin.e(TAG, "callActivityOnNewIntent:onActivityOnNewIntent", e);
            }
        }
        if (mTarget != null) {
