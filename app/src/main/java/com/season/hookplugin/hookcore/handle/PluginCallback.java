...
public class PluginCallback implements Handler.Callback {
    ...
    //            return handleServiceArgs(msg);
            ...
            LogPlugin.i(TAG, "handleMessage(%s,%s) cost %s ms", msg.what, codeToString(msg.what), (System.currentTimeMillis() - b));
...
//                    LogPlugin.i(TAG, "handleServiceArgs OK");
//                } else {
//                    LogPlugin.w(TAG, "handleServiceArgs pluginInfo==null");
//                }
//            }
//
//        } catch (Exception e) {
//            LogPlugin.e(TAG, "handleServiceArgs", e);
//        }
//        return false;
//    }
//
...
//                LogPlugin.i(TAG, "handleUnbindService OK");
//            } else {
//                LogPlugin.w(TAG, "handleUnbindService pluginInfo==null");
//            }
//        } catch (Exception e) {
//            LogPlugin.e(TAG, "handleUnbindService", e);
//        }
//        return false;
//    }
//
...
//
//                FieldUtils.writeDeclaredField(msg.obj, "intent", originPluginIntent, true);
//                LogPlugin.i(TAG, "handleBindService OK");
//            } else {
//                LogPlugin.w(TAG, "handleBindService pluginInfo==null");
//            }
//        } catch (Exception e) {
//            LogPlugin.e(TAG, "handleBindService", e);
//        }
//        return false;
//    }
//
...
//            }
//        } catch (Exception e) {
//            LogPlugin.e(TAG, "handleCreateService", e);
//        }
//        return false;
//    }
            ...
            if (targetIntent != null && !isShortcutProxyActivity(stubIntent)) {
                ...
                if (targetActivityInfo != null) {
                    ...
                    try {
                        ...
                        LogPlugin.e(TAG, "putExtra 1 fail", e);
                    }
                    ...
                    if (!success && Build.VERSION.SDK_INT <= Build.VERSION_CODES.KITKAT) {
                        try {
                            ...
                            LogPlugin.e(TAG, "putExtra 2 fail", e);
                        }
                    }
                    ...
                    LogPlugin.i(TAG, "handleLaunchActivity OK");
                } else {
                    LogPlugin.e(TAG, "handleLaunchActivity oldInfo==null");
                }
            } else {
                LogPlugin.e(TAG, "handleLaunchActivity targetIntent==null");
            }
        } catch (Exception e) {
            LogPlugin.e(TAG, "handleLaunchActivity FAIL", e);
        }
