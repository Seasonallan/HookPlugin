...
import com.season.pluginlib.hookhandle.HookedMethodHandler;
...
public abstract class ProxyHook extends Hook implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        try {
          //  LogTool.log("invoke>> "+method.getName());
         //   LogTool.log("isEnable>> "+isEnable());
           // LogTool.logV3("invoke method=" +method.getName()+"  pid="+ Binder.getCallingPid());
            if (!isEnable()) {
