...
public class PluginManager implements ServiceConnection {
    ...
    public void onServiceConnected(final ComponentName componentName, IBinder iBinder) {
        ...
        LogTool.logV3("onServiceConnected "+ Binder.getCallingPid());
        try {
    ...
    public void onServiceDisconnected(ComponentName componentName) {
        LogTool.logV3("onServiceDisconnected "+ Binder.getCallingPid());
        mPluginManager = null;
    ...
    public void connectToService() {
        if (mPluginManager == null) {
            try {
                LogTool.logV3("启动服务 PluginManagerService "+ Binder.getCallingPid());
