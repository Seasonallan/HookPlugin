...
package com.season.pluginlib.binder;

import android.app.Activity;
import android.content.Context;
import android.os.IBinder;

import com.season.pluginlib.compat.IWindowManagerCompat;
import com.season.pluginlib.hookhandle.BaseHookHandle;
import com.season.pluginlib.hookhandle.IWindowManagerHookHandle;
...
public class IWindowManagerBinderHook extends BinderHook {
    ...
    public void onInstall(ClassLoader classLoader) throws Throwable {
        ...
        try {
            ...
            LogPlugin.w(TAG, "onInstall writeStaticField to sWindowManager fail", e);
        }
    }
    ...
    public static void fixWindowManagerHook(Activity activity) {
        try {
            ...
            //LogPlugin.w(TAG, "fixWindowManagerHook writeStaticField to sWindowManager fail", e);
        }
