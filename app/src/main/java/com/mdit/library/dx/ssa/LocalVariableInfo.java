...
import com.mdit.library.dx.rop.code.RegisterSpecSet;
import com.mdit.library.dx.util.MutabilityControl;

/**
 * Container for local variable information for a particular {@link
 * SsaMethod}.
 * Stolen from {@link com.mdit.library.dx.rop.code.LocalVariableInfo}.
 */
public class LocalVariableInfo         extends MutabilityControl {
     ...
     * {@link com.mdit.library.dx.rop.type.TypeBearer} (such as a constant value).
     *
