...
import com.season.hookplugin.compat.ActivityManagerCompat;
import com.season.hookplugin.compat.Env;
import com.season.hookplugin.tool.FieldUtils;
import com.season.hookplugin.tool.LogPlugin;
import com.season.hookplugin.tool.MethodUtils;
import com.season.hookplugin.core.PluginManager;
import com.season.hookplugin.core.PluginManagerService;
import com.season.hookplugin.core.PluginProcessManager;
import com.season.hookplugin.stub.MyFakeIBinder;
import com.season.hookplugin.stub.RunningActivities;
import com.season.hookplugin.stub.ServcesManager;
import com.season.hookplugin.stub.ShortcutProxyActivity;
...
public class HookHandleActivityManager extends BaseHookHandle {
    ...
    private static final String TAG = HookHandleActivityManager.class.getSimpleName();

    public HookHandleActivityManager(Context hostContext) {
        super(hostContext);
    }
    ...
    private static class clearApplicationUserData extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class bindService extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class publishService extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class stopService extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class stopServiceToken extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private class serviceDoneExecuting extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class startActivity extends BaseHookMethodHandlerOfReplaceCallingPackage {
...
//                        }
    ...
    private static class startActivityIntentSender extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class startActivityFromRecents extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class finishActivity extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class registerReceiver extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class broadcastIntent extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class unbroadcastIntent extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class getCallingPackage extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class getCallingActivity extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class getAppTasks extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class addAppTask extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class getTasks extends BaseHookMethodHandlerOfReplaceCallingPackage {
...
//        }
    ...
    private static class getServices extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class getProcessesInErrorState extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class removeContentProviderExternal extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class publishContentProviders extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class getRunningServiceControlPanel extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class startService extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class setServiceForeground extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class unbindFinished extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class peekService extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class bindBackupAgent extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class backupAgentCreated extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class unbindBackupAgent extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class killApplicationProcess extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class startInstrumentation extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class getActivityClassForToken extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class getPackageForToken extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class handleIncomingUser extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class grantUriPermission extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class getPersistedUriPermissions extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class killBackgroundProcesses extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class forceStopPackage extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class getRunningAppProcesses extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class getRunningExternalApplications extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class getMyMemoryState extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class crashApplication extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class grantUriPermissionFromOwner extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class checkGrantUriPermission extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class startActivities extends BaseHookMethodHandlerOfReplaceCallingPackage {
...
//                            }
    ...
    /*ONLY for   api 15 or later*/
    private static class getPackageScreenCompatMode extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    /*ONLY for   api 15 or later*/
    private static class setPackageScreenCompatMode extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    /*ONLY for   api 15 or later*/
    private static class getPackageAskScreenCompat extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    /*ONLY for  api 15 or later*/
    private static class setPackageAskScreenCompat extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static class navigateUpTo extends BaseHookMethodHandlerOfReplaceCallingPackage {
    ...
    private static ComponentName selectProxyActivity(ActivityInfo pluginInfo) {
        try {
            if (pluginInfo != null) {
                ActivityInfo proxyInfo = PluginManager.getInstance().selectStubActivityInfo(pluginInfo);
                if (proxyInfo != null) {
                    return new ComponentName(proxyInfo.packageName, proxyInfo.name);
                }
            }
